...
public class TravelService {
	...
	public String addItinerary(Itinerary itinerary) {
		...
		itinerary.getFlightReservation().setItineraryId(itineraryId);
		itinerary.getHotelReservation().setItineraryId(itineraryId);
		itinerary.getCarReservation().setItineraryId(itineraryId);
		this.flightReservationRepository.add(itinerary.getFlightReservation());
		this.hotelReservationRepository.add(itinerary.getHotelReservation());
		this.carReservationRepository.add(itinerary.getCarReservation());
		return itineraryId;
	}
